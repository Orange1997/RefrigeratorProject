...
public class SlideRecyclerView extends NoScrollRecyclerView {
    ...
    private boolean isToSlide;   // 是否滑动
    ...
    public boolean isToSlide() {
        return isToSlide;
    }

    public void setToSlide(boolean toSlide) {
        isToSlide = toSlide;
    }
}