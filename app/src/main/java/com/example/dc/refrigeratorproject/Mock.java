...
public class Mock {
    ...
    public static RefrigeratorModel getRefrigeratorModel1() {
        ...
        LoginRes creator = new LoginRes ();
//        creator.setName ("司二北");
//        creator.setAccount ("15869117281");
//        creator.setHead ("");
...
//        creator.getData ().get (0).setName ("哈哈哈");
